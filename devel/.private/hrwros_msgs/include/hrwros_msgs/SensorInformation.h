...
struct Definition< ::hrwros_msgs::SensorInformation_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sensor_msgs/Range sensor_data	# placeholder for ROS message type for interfacing with distance sensors\n"
